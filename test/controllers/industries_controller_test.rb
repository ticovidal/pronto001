...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post industries_url, params: { industry: { profile_id: @industry.profile_id, team: @industry.team, technic: @industry.technic } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { profile_id: @industry.profile_id, team: @industry.team, technic: @industry.technic } }
