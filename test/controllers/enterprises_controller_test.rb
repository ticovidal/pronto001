...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { cnpj: @enterprise.cnpj, company: @enterprise.company, enterpriseable_id: @enterprise.enterpriseable_id, enterpriseable_type: @enterprise.enterpriseable_type, social: @enterprise.social } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { cnpj: @enterprise.cnpj, company: @enterprise.company, enterpriseable_id: @enterprise.enterpriseable_id, enterpriseable_type: @enterprise.enterpriseable_type, social: @enterprise.social } }
